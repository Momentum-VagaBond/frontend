...
export const StartTripCard = () => {
    ...
    return (
    <CardActionArea component={RouterLink} to={"/newtrip"}>
    <Card  sx={{
        marginTop: 4,
        maxWidth: 300,
    ...
    {/* fontFamily="Permanent Marker, cursive" */}
        <Typography gutterBottom mb={2} mt={2} align="center" variant="h6" component="div" backgroundColor="#FAFAFA" > 
        <strong>+</strong> Create new trip
